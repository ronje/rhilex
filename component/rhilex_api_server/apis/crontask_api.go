...
import (
	...
	"github.com/hootrhino/rhilex/component/rhilex_api_server/dto"
...
func CreateCronTask(c *gin.Context, ruleEngine typex.Rhilex) (any, error) {
	// 1. 从c中取出数据
...
func DeleteCronTask(c *gin.Context, ruleEngine typex.Rhilex) (any, error) {
	uuid := c.Query("uuid")
...
func ListCronTask(c *gin.Context, ruleEngine typex.Rhilex) (any, error) {
...
func UpdateCronTask(c *gin.Context, ruleEngine typex.Rhilex) (any, error) {
...
func StartTask(c *gin.Context, ruleEngine typex.Rhilex) (any, error) {
...
func StopTask(c *gin.Context, ruleEngine typex.Rhilex) (any, error) {
	uuid, ok := c.GetQuery("uuid")
	if !ok {
		return nil, errors.New("uuid must not be null")
	}
...
func TerminateRunningTask(c *gin.Context, ruleEngine typex.Rhilex) (any, error) {
