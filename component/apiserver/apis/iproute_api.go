...
func SetDHCP(c *gin.Context, ruleEngine typex.Rhilex) {
	dhcpVo := DHCPVo{}
...
func GetDHCP(c *gin.Context, ruleEngine typex.Rhilex) {
...
*
 */
func GetOldDefaultIpRoute(c *gin.Context, ruleEngine typex.Rhilex) {
...
func SetNewDefaultIpRoute(c *gin.Context, ruleEngine typex.Rhilex) {
	form := IpRouteVo{}
...
*
 */
func GetDhcpClients(c *gin.Context, ruleEngine typex.Rhilex) {
...
*
 */
func DeleteDhcpClient(c *gin.Context, ruleEngine typex.Rhilex) {
	c.JSON(common.HTTP_OK, common.Ok())
}
...
*
 */
func CleanDhcpClients(c *gin.Context, ruleEngine typex.Rhilex) {
	f, err := os.Open("/var/lib/dhcp/dhcpd.leases")
	if err != nil {
		c.JSON(common.HTTP_OK, common.Error400(err))
	}
