...
func UserProtocolMasterPointsExport(c *gin.Context, ruleEngine typex.Rhilex) {
	...
	result := interdb.InterDb().Table("m_user_protocol_data_points").
...
func UserProtocolMasterSheetPageList(c *gin.Context, ruleEngine typex.Rhilex) {
	...
	var count int64
	err1 := interdb.InterDb().Model(&model.MUserProtocolDataPoint{}).
...
func (md UserProtocolDeviceDto) GetConfig() map[string]any {
