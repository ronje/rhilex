...
*
 */
func ABCD(rx typex.Rhilex, uuid string) func(*lua.LState) int {
...
func DCBA(rx typex.Rhilex, uuid string) func(*lua.LState) int {
	return func(l *lua.LState) int {
		data := l.ToString(2)
		start := l.ToInt(3)
		end := l.ToInt(4)
...
func BADC(rx typex.Rhilex, uuid string) func(*lua.LState) int {
	return func(l *lua.LState) int {
		data := l.ToString(2)
		start := l.ToInt(3)
		end := l.ToInt(4)
...
func CDAB(rx typex.Rhilex, uuid string) func(*lua.LState) int {
	return func(l *lua.LState) int {
		data := l.ToString(2)
		start := l.ToInt(3)
		end := l.ToInt(4)
