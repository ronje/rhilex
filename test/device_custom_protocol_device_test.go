...
// FFFFFF014CB2AA55
// go test -timeout 30s -run ^TestHexEncoding github.com/hootrhino/rhilex/test -v -count=1
...
// go test -timeout 30s -run ^TestCheckSUM github.com/hootrhino/rhilex/test -v -count=1
...
// go test -timeout 30s -run ^TestCustomProtocolDevice github.com/hootrhino/rhilex/test -v -count=1
...
// go test -timeout 30s -run ^Test_SerialPortRW github.com/hootrhino/rhilex/test -v -count=1
