...
func (t *TCPTransport) SendRequest(data []byte, timeout time.Duration) error {
	if t.conn == nil {
...
func (t *TCPTransport) ReadResponse(headerLength int, timeout time.Duration) ([]byte, error) {
	if t.conn == nil {
...
func (t *TCPTransport) Status() error {
	if t.conn == nil {
		return fmt.Errorf("no connection established")
	}
	return nil
